...
const ProjectItem = ({title, backgroundImg, projectUrl}) => {
  return (
    ...
    <div className="hidden group-hover:block absolute translate-x-[-50%] translate-y-[-50%] ">
      <h3 className="text-2xl text-blue-600 tracking-widest text-center">{title}</h3>
      <p className="text-2xl text-blue-600 tracking-widest">React.js</p>
      <Link href={projectUrl}>
        <p className="text-center py-3 rounded-lg bg-blue-700 text-gray-900 font-bold text-lg ">More Info</p>
      </Link>
    </div>
  </div>
    </div>
